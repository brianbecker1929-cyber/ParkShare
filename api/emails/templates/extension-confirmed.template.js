// "Extension confirmed" email — sent after a successful "Add
// Additional Time" payment. Raw HTML with [VARIABLE] placeholders.
// Same visual system as the other three templates.
...
<title>Your Parker Session Extension is Confirmed</title>
  ...
  <tr>
    <td align="center">
      <table role="presentation" width="640" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:7px; overflow:hidden; max-width:640px; width:100%;">
        ...
        <!-- ===== STATIC: EXTENSION CONFIRMATION GRAPHIC ===== -->
        <tr>
          <td style="padding:8px 29px 0 29px;" align="left">
          <img src="https://www.myparkshare.ca/email/extension-confirmed-headline.png" width="192" height="87" alt="Extension Confirmed" style="display:block; border:0;">
          </td>
        </tr>
        ...
        <!-- ===== DYNAMIC: CONFIRMATION STATUS BANNER ===== -->
        <tr>
                  ...
                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <td valign="middle" style="padding-left:7px;">
                        <p style="margin:0; font-size:7px; font-weight:bold; letter-spacing:0.3px; text-transform:uppercase; color:#f5a623;">Extension Confirmed</p>
                        <p style="margin:1px 0 0 0; font-size:11px; font-weight:bold; color:#ffffff;">+[ADDED_TIME] added</p>
                        <p style="margin:1px 0 0 0; font-size:8px; color:#c3ccd9;">New end: [NEW_END_DATE_FULL] at [NEW_END_TIME]</p>
                      </td>
                    </tr>
                  </table>
                </td>
                  ...
                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td width="40" valign="top" style="padding-bottom:16px;">
                        <img src="https://www.myparkshare.ca/email/icon-clock.png" width="32" height="32" alt="Extended by" style="display:block; border:0;">
                      </td>
                      <td valign="top" style="padding-bottom:16px; padding-left:11px;">
                        <p style="margin:0; font-size:11px; text-transform:uppercase; letter-spacing:0.45px; color:#8a94a6;">Extended By</p>
                        <p style="margin:2px 0 0 0; font-size:14px; font-weight:bold; color:#1c2b4a;">+[ADDED_TIME]</p>
                        <p style="margin:2px 0 0 0; font-size:12px; color:#4a5568;">[AMOUNT_CHARGED] charged</p>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td width="40" valign="top" style="padding-bottom:16px;">
                        <img src="https://www.myparkshare.ca/email/icon-calendar.png" width="32" height="32" alt="New end time" style="display:block; border:0;">
                      </td>
                      <td valign="top" style="padding-bottom:16px; padding-left:11px;">
                        <p style="margin:0; font-size:11px; text-transform:uppercase; letter-spacing:0.45px; color:#8a94a6;">New End Time</p>
                        <p style="margin:2px 0 0 0; font-size:14px; font-weight:bold; color:#1c2b4a;">[NEW_END_TIME]</p>
                        <p style="margin:2px 0 0 0; font-size:12px; color:#4a5568;">[NEW_END_DATE_FULL]</p>
                      </td>
                    </tr>
        ...
        <tr>
          <td style="padding:14px 22px 0 22px;" align="center">
            ...
            <p style="margin:6px 0 0 0; font-size:11px; color:#8a94a6; text-align:center;">See or manage your booking anytime</p>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td style="padding:0 22px 22px 22px;" align="center">
            <a href="[EXTEND_URL]" style="display:block; background-color:#ffffff; border:2px solid #001d3d; color:#001d3d; text-decoration:none; font-size:14px; font-weight:bold; padding:12px 25px; border-radius:10px; text-align:center;">
              Need even more time?
            </a>
          </td>
        </tr>
