...
<title>Your Parker Reservation is Confirmed</title>
  ...
  <tr>
    <td align="center">
      <table role="presentation" width="640" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:7px; overflow:hidden; max-width:640px; width:100%;">
        ...
        <!-- ===== STATIC: PARKING CONFIRMATION GRAPHIC ===== -->
        <tr>
          <td style="padding:8px 29px 0 29px;" align="left">
          <img src="https://www.myparkshare.ca/email/confirmation-headline.png" width="192" height="84" alt="Booking Confirmed" style="display:block; border:0;">
          </td>
        </tr>
                  ...
                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <td valign="middle" style="padding-left:7px;">
                        <p style="margin:0; font-size:7px; font-weight:bold; letter-spacing:0.3px; text-transform:uppercase; color:#f5a623;">Reservation Confirmed</p>
                        <p style="margin:1px 0 0 0; font-size:11px; font-weight:bold; color:#ffffff;">Confirmation #[CONFIRMATION_NUMBER]</p>
                        <p style="margin:1px 0 0 0; font-size:8px; color:#c3ccd9;">[SESSION_START_DATE_LABEL] at [SESSION_START_TIME]</p>
                      </td>
                    </tr>
                  </table>
                </td>
                  ...
                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      ...
                      <td valign="top" style="padding-bottom:16px; padding-left:11px;">
                        <p style="margin:0; font-size:11px; text-transform:uppercase; letter-spacing:0.45px; color:#8a94a6;">Start Time</p>
                        <p style="margin:2px 0 0 0; font-size:14px; font-weight:bold; color:#1c2b4a;">[SESSION_START_TIME]</p>
                        <p style="margin:2px 0 0 0; font-size:12px; color:#4a5568;">[ENTRY_DATE_FULL]</p>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td valign="top" style="padding-bottom:16px; padding-left:11px;">
                        <p style="margin:0; font-size:11px; text-transform:uppercase; letter-spacing:0.45px; color:#8a94a6;">End Time</p>
                        <p style="margin:2px 0 0 0; font-size:14px; font-weight:bold; color:#1c2b4a;">[SESSION_END_TIME]</p>
