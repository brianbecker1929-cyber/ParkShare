...
function DriverPage({ tab, onTabChange, onLogoClick, user, onShowAuth, onSignOut, onLegalClick, onContactClick, onTrustClick, onFindParking, onAboutClick, onHostClick, onHelpClick }) {
  ...
  const steps = [
    { n: 1, title: "Search", text: "Enter where you're going and when you need parking." },
    { n: 2, title: "Compare", text: "Review available spaces, prices, locations and listing details." },
    { n: 3, title: "Book", text: "Choose the parking space that works for your trip and complete your reservation." },
    { n: 4, title: "Arrive", text: "Follow the Host's parking instructions and park during your confirmed reservation period." },
    { n: 5, title: "Go", text: "Get on with the reason you came in the first place." },
  ];
      ...
      <main className="ps-driver-v2-main">
        ...
        <section id="how" className="ps-driver-v2-section">
          <div className="ps-driver-v2-section-heading">
            ...
            <h2>From search to parked in five simple steps.</h2>
          </div>
